...
This research adopts a Design Science Research (DSR) methodology combined with a positivist paradigm. The study seeks to design, develop, and evaluate an Artificial Intelligence artifact capable of addressing a real-world problem.

The methodological process will include problem identification, data collection, artifact design, model development, simulation generation, evaluation, and refinement. Bayesian Deep Learning models and Generative AI techniques will be trained using crime statistics, geospatial information, demographic indicators, and public security datasets from Lima Metropolitana.

The research will follow reproducible science practices through Git, DVC, Docker, and MLflow.
